...
import { GestionesListPage } from "./pages/GestionesListPage";
import { ExtractionsListPage } from "./pages/ExtractionsListPage";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route path="/gestiones" element={<Layout><GestionesListPage /></Layout>} />
